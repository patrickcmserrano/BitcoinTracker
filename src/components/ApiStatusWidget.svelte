<script lang="ts">
  ...
  import {
    apiHealthService,
    type APIStatus,
  } from "../lib/services/apiHealthService";
  ...
  async function checkAllAPIs() {
    ...
    const [binanceResult, futuresResult, altMeResult, coinGeckoResult] =
      await Promise.all([
        apiHealthService.checkBinanceHealth(),
        apiHealthService.checkBinanceFuturesHealth(),
        apiHealthService.checkAlternativeMeHealth(),
        apiHealthService.checkCoinGeckoHealth(),
      ]);
    ...
    apiStatuses = [
      {
        ...
        error:
          binanceResult.status === "online" ? undefined : binanceResult.error,
        lastCheck: new Date(),
      },
      {
        ...apiStatuses[1],
        ...
        error:
          futuresResult.status === "online" ? undefined : futuresResult.error,
        lastCheck: new Date(),
      },
      {
        ...apiStatuses[2],
      ...
      },
      {
        ...
        error:
          coinGeckoResult.status === "online"
            ? undefined
            : coinGeckoResult.error,
        lastCheck: new Date(),
      },
      {
        ...apiStatuses[4],
...
<div class="api-status-container">
  ...
  <div class="status-header">
    <div class="header-left">
      ...
      <span
        class="status-badge"
        class:badge-success={statusCounts.online === statusCounts.total}
        class:badge-warning={statusCounts.online < statusCounts.total}
      >
      ...
      <div class="api-section">
        ...
        <div class="api-list">
          {#each apiStatuses as api}
            <div
              class="api-item"
              class:api-online={api.status === "online"}
              class:api-offline={api.status === "offline"}
              class:api-checking={api.status === "checking"}
            >
              <div class="api-main">
