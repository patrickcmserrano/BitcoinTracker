...
<div
  ...
  style="background-color: var(--app-background); color: var(--app-text);"
>
  ...
  <main
    class="min-h-screen px-3 py-2 mx-auto flex flex-col w-full app-main"
    class:fullhd-layout={isFullHD}
  >
    <!-- Conteúdo baseado na view ativa -->
    {#if currentView === "dashboard"}
      <!-- Conteúdo principal com altura responsiva -->
      <div class="content-container flex-grow space-y-1.5 flex flex-col">
    ...
    <!-- Footer compacto -->
    <footer
      class="mt-2 pt-2 border-t border-gray-200 dark:border-gray-700 text-center flex-shrink-0"
    >
